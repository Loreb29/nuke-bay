package com.lorez.nuke_bay.neoforge.ModData;

import com.lorez.nuke_bay.neoforge.files.entity.bullet.TinyNuke;
import com.lorez.nuke_bay.neoforge.files.entity.weapon.NukeBay;
...
public class NukeBayData {
    ...
    static <T extends Entity> Supplier<EntityType<T>> registeer(String name, EntityType.Builder<T> builder) {
        ResourceLocation id =  ResourceLocation.fromNamespaceAndPath(NukeBayData.MOD_ID, name);
        return Registration.register(BuiltInRegistries.ENTITY_TYPE, id, () -> builder.build(id.toString()));
    }
    public static ResourceLocation locate(String name) {
        return ResourceLocation.fromNamespaceAndPath(NukeBayData.MOD_ID, name);
    }
